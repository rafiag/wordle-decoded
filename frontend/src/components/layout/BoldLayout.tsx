...
import { trackClickFooterLink } from '../../analytics/events';
...
export default function BoldLayout() {
    const handleFooterLinkClick = (
        category: 'data_source' | 'github' | 'license' | 'built_with',
        text: string,
        url: string
    ) => {
        trackClickFooterLink({
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-6">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <a
                                    ...
                                    onClick={() => handleFooterLinkClick('github', 'View on GitHub', 'https://github.com/rafiag/wordle-decoded')}
                                >
                                ...
                                <div className="text-gray-400 text-xs space-y-1">
                                    <p>
                                        <a
                                            ...
                                            onClick={() => handleFooterLinkClick('data_source', 'Wordle Games Dataset', 'https://www.kaggle.com/datasets/scarcalvetsis/wordle-games')}
                                        >
                                    ...
                                    <p>
                                        <a
                                            ...
                                            rel="noopener noreferrer"
                                            className="hover:text-cyan-300 transition-colors underline decoration-dotted"
                                            onClick={() => handleFooterLinkClick('data_source', 'Wordle Tweets Dataset', 'https://www.kaggle.com/datasets/benhamner/wordle-tweets')}
                                        >
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-500">
                            <p>
                                ...
                                <a
                                    ...
                                    onClick={() => handleFooterLinkClick('github', 'rafiag', 'https://github.com/rafiag')}
                                >
                                    rafiag
                                </a>
                            </p>
                            <div className="flex items-center gap-4">
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                    className="hover:text-cyan-400 transition-colors"
                                    onClick={() => handleFooterLinkClick('license', 'MIT License', 'https://github.com/rafiag/wordle-decoded/blob/main/LICENSE')}
                                >
                                    MIT License
                                </a>
